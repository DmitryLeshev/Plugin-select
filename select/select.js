const getTemplate = (data = [] , placeholder, selectedId) => {
    ...
    <div class="select__input" data-type="input">
        <span class="input__text" data-type="value">${text}</span>
        <i class="select__icon fa fa-chevron-down" data-type="arrow"></i>
    </div>
...
export class Select {
    ...
    select(id) {
        ...
        this.$el.querySelector(`[data-id="${this.selectedId}"]`).classList.add('select__item_selected')
